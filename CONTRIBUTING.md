Contributing to Aquila Core
==================================

The Aquila Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Aquila Core project, and is not to be
confused with overall Aquila Network Protocol consensus changes.

Whether a pull request is merged into Aquila Core rests with the project merge
...
Patches that change Aquila consensus rules are considerably more involved than
...
Where a patch set proposes to change the Aquila consensus, it must have been
...
The project leader is the release manager for each Aquila Core release.
