...
TRANSLATIONS += src/qt/locale/Aquila_bg.ts \
                src/qt/locale/Aquila_de.ts \
                src/qt/locale/Aquila_en.ts \
                src/qt/locale/Aquila_es.ts \
                src/qt/locale/Aquila_fi.ts \
                src/qt/locale/Aquila_fr.ts \
                src/qt/locale/Aquila_it.ts \
                src/qt/locale/Aquila_ja.ts \
                src/qt/locale/Aquila_pl.ts \
                src/qt/locale/Aquila_pt.ts \
                src/qt/locale/Aquila_ru.ts \
                src/qt/locale/Aquila_sk.ts \
                src/qt/locale/Aquila_sv.ts \
                src/qt/locale/Aquila_vi.ts \
                src/qt/locale/Aquila_zh_CN.ts \
                src/qt/locale/Aquila_zh_TW.ts
