...
Intro
-----
Aquila (AQX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Aquila utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run Aquila-qt.exe.

Aquila Core is the original Aquila client and it builds the backbone of the network.
However, it downloads and stores the entire history of Aquila transactions;
