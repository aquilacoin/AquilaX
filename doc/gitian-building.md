...
*Setup instructions for a gitian build of Aquila using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Aquila
...
Clone the git repositories for Aquila and gitian and then checkout the Aquila version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the Aquila repository
...
To build Aquila (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the Aquila repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/Aquila/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/Aquila/Aquila
...
For example:
```bash
URL=https://github.com/konez2k/Aquila.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit Aquila=${COMMIT} --url Aquila=${URL} ../Aquila/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit Aquila=${COMMIT} --url Aquila=${URL} ../Aquila/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit Aquila=${COMMIT} --url Aquila=${URL} ../Aquila/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/Aquila-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/Aquila-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/Aquila-build.assert
```
...
[Aquila/gitian.sigs](https://github.com/Aquila/gitian.sigs/) repository, or if that's not possible to create a pull
request.
