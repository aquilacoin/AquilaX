...
In order to support loading of multiple wallets in Aquila-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Aquila.cpp.
...
Changes to Aquila.cpp
----------------------
Aquila.cpp is the entry point into Aquila-qt, and as such, will require some minor modifications to provide hooks for
