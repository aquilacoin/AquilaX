...
This mechanism has been integrated into Bitcore-Node-Aquila which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Aquila/insight-api-Aquila#web-socket-api](https://github.com/Aquila/insight-api-Aquila#web-socket-api)
* API: [https://github.com/Aquila/insight-api-Aquila#swifttx-transactions](https://github.com/Aquila/insight-api-Aquila#swifttx-transactions)
...
By default, the Aquila Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Aquila Core daemon:
