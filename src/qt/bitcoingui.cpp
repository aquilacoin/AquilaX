                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Aquila Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aqx: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Aquila Core"), this);
    aboutAction->setStatusTip(tr("Show information about Aquila Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Aquila"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AQX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AQX addresses"));
    ...
    openAction->setStatusTip(tr("Open a Aquila: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Aquila Core help message to get a list with possible Aquila command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Aquila Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Aquila network", "", count));
}
...
{
    QString strTitle = tr("Aquila Core"); // default title
