...
/** Utility functions used by the Aquila Qt UI.
 */
namespace GUIUtil
{
...
// Render AQX addresses in monospace font
...
// Parse "Aquila:" URI into recipient object, return true on successful parsing
