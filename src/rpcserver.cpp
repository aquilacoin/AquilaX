...
uint256 ParseHashV(const UniValue& v, string strName)
{
    ...
    if (!IsHex(strHex)) // Note: IsHex("") is false
        throw JSONRPCError(RPC_INVALID_PAQXMETER, strName + " must be hexadecimal string (not '" + strHex + "')");
    uint256 result;
...
int ParseInt(const UniValue& o, string strKey)
{
    ...
    if (v.isNum())
        throw JSONRPCError(RPC_INVALID_PAQXMETER, "Invalid parameter, " + strKey + "is not an int");
...
bool ParseBool(const UniValue& o, string strKey)
{
    const UniValue& v = find_value(o, strKey);
    if (v.isBool())
        throw JSONRPCError(RPC_INVALID_PAQXMETER, "Invalid parameter, " + strKey + "is not a bool");
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Aquila features */
        {"Aquila", "masternode", &masternode, true, true, false},
        {"Aquila", "listmasternodes", &listmasternodes, true, true, false},
        {"Aquila", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Aquila", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Aquila", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Aquila", "masternodedebug", &masternodedebug, true, true, false},
        {"Aquila", "startmasternode", &startmasternode, true, true, false},
        {"Aquila", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Aquila", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Aquila", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Aquila", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Aquila", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Aquila", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Aquila", "mnbudget", &mnbudget, true, true, false},
        {"Aquila", "preparebudget", &preparebudget, true, true, false},
        {"Aquila", "submitbudget", &submitbudget, true, true, false},
        {"Aquila", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Aquila", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Aquila", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Aquila", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Aquila", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Aquila", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Aquila", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Aquila", "checkbudgets", &checkbudgets, true, true, false},
        {"Aquila", "mnsync", &mnsync, true, true, false},
        {"Aquila", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> Aquila-cli " + methodname + " " + args + "\n";
}
