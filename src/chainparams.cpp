...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("198.46.242.116","198.46.242.116"));
        ...
        // Aquila BIP44 coin type is '222' (0x800000de)
...
public:
    ...
    virtual void setRejectBlockOutdatedMajority(int AQXejectBlockOutdatedMajority) { nRejectBlockOutdatedMajority = AQXejectBlockOutdatedMajority; }
