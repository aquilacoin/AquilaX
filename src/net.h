...
typedef enum BAQXeason
{
    BAQXeasonUnknown          = 0,
    BAQXeasonNodeMisbehaving  = 1,
    BAQXeasonManuallyAdded    = 2
} BAQXeason;
...
public:
    ...
    void SetNull()
    {
        ...
        nCreateTime = 0;
        nBanUntil = 0;
        bAQXeason = BAQXeasonUnknown;
    }

    std::string bAQXeasonToString()
    {
        switch (bAQXeason) {
        case BAQXeasonNodeMisbehaving:
            return "node misbehabing";
        case BAQXeasonManuallyAdded:
...
public:
    ...
    static void Ban(const CNetAddr &ip, const BAQXeason &bAQXeason, int64_t bantimeoffset = 0, bool sinceUnixEpoch = false);
    static void Ban(const CSubNet &subNet, const BAQXeason &bAQXeason, int64_t bantimeoffset = 0, bool sinceUnixEpoch = false);
