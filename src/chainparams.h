...
// Copyright (c) 2017 The Aquila Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BITCOIN_CHAINPAQXMS_H
#define BITCOIN_CHAINPAQXMS_H
 ...
 * Aquila system. There are three: the main network on which people trade goods
...
public:
    ...
    virtual void setRejectBlockOutdatedMajority(int AQXejectBlockOutdatedMajority) = 0;
