...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Aquila Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  Aquila-cli [options] <command> [params]  " + _("Send command to Aquila Core") + "\n" +
                        "  Aquila-cli [options] help                " + _("List commands") + "\n" +
                        "  Aquila-cli [options] help <command>      " + _("Get help for a command") + "\n";
