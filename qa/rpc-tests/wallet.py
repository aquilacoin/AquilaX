...
#   c) node1 mines 32 blocks, so now node 0 has 500000AQX, node 1 has 4250AQX, node2 has none.
#   d) node0 sends 601 AQX to node2, in two transactions (301 AQX, then 300 AQX).
